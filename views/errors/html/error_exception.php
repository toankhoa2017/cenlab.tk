...
<div class="content-wrapper">
    <section class="content-header"><h1>An uncaught Exception was encountered</h1></section>
    <section class="content">
    <div class="error-page">
    <h2 class="headline text-yellow">500</h2>
    <div class="error-content" style="padding-top:5px;">
    <h3><i class="fa fa-warning text-yellow"></i> An uncaught Exception was encountered</h3>
