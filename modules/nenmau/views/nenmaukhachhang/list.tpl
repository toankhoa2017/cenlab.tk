        ...
        $(document).ready(function () {
            ...
            $('#dieukienluu').catcomplete({
                ...
                source: function (request, response) {
                    $.ajax({
                        type: "POST",
                        url: "{site_url()}nenmau/nenmaukhachhang/goiy_dieukienluu",
                        dataType: "json",
                        data: {
                            key: request.term
                        },
    ...
    {literal}
        <script type="text/javascript">
            function load_select_nenmau(id) {
                $.ajax({
                    type: "POST",
                    url: site_url + "nenmau/nenmaukhachhang/load_select_nenmau",
                    datatype: "text",
                    success: function (data) {
                        $("#idparent").html('');
            ...
            function load_tree() {
                $.ajax({
                    type: "POST",
                    url: site_url + "nenmau/nenmaukhachhang/tree_data",
                    data: {
                        'search': $("#tukhoa").val()
                    },
                    dataType: "json",
            ...
            function hihi(id) {
                window.location = site_url + "nenmau/chitieukhachhang?khachhang=" + khachhang + "&nenmau=" + id;
            }
        </script>
    {/literal}
    <script type="text/javascript">
        ...
        function load_select_donvi(id) {
            $.ajax({
                type: "POST",
                url: "{site_url()}nenmau/nenmaukhachhang/danhsach_donvi",
                datatype: "text",
                success: function (data) {
                    $("#donvi").html('');
                    $("#donvi").append(data);
                ...
                buttons: {
                    '{$languages.co}': {
                        ...
                        action: function () {
                            $.ajax({
                                type: "POST",
                                url: "{site_url()}nenmau/nenmaukhachhang/xoanenmau",
                                data: {
                                    idnenmauxoa: id
                                },
                                datatype: "text",
                    ...
                    buttons: {
                        '{$languages.co}': {
                            ...
                            action: function () {
                                $.ajax({
                                    type: "POST",
                                    url: "{site_url()}nenmau/nenmaukhachhang/suanenmau",
                                    data: {
        ...
        function _save() {
            if ($("#name").val() == "") {
                ...
                $.ajax({
                    url: "{site_url()}nenmau/nenmaukhachhang/ajax_add",
                    type: "POST",
                    data: $('#form').serialize(),
                    dataType: "JSON",
                    success: function (data) {
                        ...
                        '{$languages.co}': {
                            ...
                            action: function () {
                                $.ajax({
                                    ...
                                    url: "{site_url()}nenmau/nenmaukhachhang/chat/setgia",
                                    success: function (data) {
