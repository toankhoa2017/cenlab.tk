        ...
        buttons: {
            '{$languages.co}': {
                ...
                action: function () {
                    ...
                    $('#ncc_id' + id).attr("style", "display:none");
                    $('#dn_detail_dongia' + id).attr("style", "display:none");
        ...
        <div class="main-content-inner">
            ...
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active"><a href="{site_url()}muasam/duyetmua">{$languages.url_2}</a></li>
            ...
            <div class="page-content">
                <div class="row">
                    <div class="col-xs-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="chosen-select form-control" id="nhansu_nhan" name="nhansu_nhan">
                                        ...
                                        {foreach from=$nhansu key=k item=v}
                                            <option {if $denghi->denghi_vesion==5&&$denghi->nhansu_nhan==$k} selected {/if} value="{$k}">{$v}</option>
                                        {/foreach}
                                    </select>
                                </div>
                            </div>
                        ...
                        {if $quytrinh == 4 || $denghi->denghi_approve==2}
