...
{block name=script}
    ...
    <script>
        ...
        function add_sanpham(level) {
            var loai_id = '<div class="col-md-2"><div class="form-group" id="loai_id' + level + '"><label class="control-label">{$languages.loaisanpham}</label><select class="chosen-select form-control" name="loai_id" id="loai_id' + level + '" level="' + level + '" onchange="load_sanpham(' + level + ')"><option value="0">{$languages.chosen_loaisanpham}</option>{foreach from=$loaisanpham key=k item=v}<option value="{$k}">{$v}</option>{/foreach}</select></div></div>';
            var sp_id = '<div class="col-md-2"><div class="form-group" id="sp_id' + level + '"><label class="control-label">{$languages.sanpham}</label><select class="chosen-select form-control" name="sp_id" id="sp_id' + level + '" level="' + level + '"><option value="0">{$languages.chosen_sanpham}</option></select></div></div>';
            ...
            var ghichu = '<div class="col-md-2"><div class="form-group" id="ghichu' + level + '"><label class="control-label">Ghi Chú</label><input class="form-control" type="text" name="ghichu" id="ghichu' + level + '" placeholder="" value="" level="' + level + '"></div></div>';
            $(".class-sanpham").append('<div class="row">' + loai_id + sp_id + dn_detail_soluong + donvitinh_id + hang_id + ghichu + '</div>');
        ...
        function load_sanpham(level_check) {
            $.ajax({
                type: "POST",
                data: {
        ...
        function _create() {
            ...
            for (i = 0; i < ds_sanpham.length; i++) {
                ...
                var check_false3 = 0;
                var check_false4 = 0;
                if ($('select[name=loai_id][level=' + ds_sanpham[i] + ']').val() == '0') {
                    kiemtra = false;
                    check_false1 = 1;
                    $('#loai_id' + ds_sanpham[i]).addClass('has-error');
                }
                ;
                ...
                ;
                if ((check_false1 == 0 && check_false2 == 0 && check_false3 == 0 && check_false4 == 0) || (check_false3 == 3)) {
                } else {
                    check_false = false;
                }
                if (kiemtra == true) {
                    danhsach_loai_id.push($('select[name=loai_id][level=' + ds_sanpham[i] + ']').val());
                                    ...
                                    $.ajax({
                                        ...
                                        success: function (data) {
                                            if (data == 1) {
                                                ...
                                                swal("{$languages.thatbai}", "{$languages.thatbai_false1}", "error");
                                            }
                                        }
                                    });
                                }
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control data-info" type="text" id="denghi_title" name="denghi_title" placeholder="{$languages.placeholder_tieude}" value="">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                        ...
                        <div class="form-group ">
                            ...
                            <textarea class="form-control" name="denghi_describe" id="denghi_describe" rows="5" placeholder="{$languages.placeholder_ghichu}"></textarea>
                        </div>
                                ...
                                <div class="widget-box">
                                    ...
                                    <div class="widget-body">
                                        <div class="widget-main class-sanpham">
                                            <div class="row">
                                                <div class="col-md-2">
                                                    <div class="form-group" id="loai_id1">
                                                        <label class="control-label">{$languages.loaisanpham}</label>
                                                        <select class="chosen-select form-control" name="loai_id" level="1" onchange="load_sanpham(1)">
                                                            <option value="0">{$languages.chosen_loaisanpham}</option>
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group" id="sp_id1">
                                                        <label class="control-label">{$languages.sanpham}</label>
                                                        <select class="chosen-select form-control" name="sp_id" level="1">
                                                            <option value="0">{$languages.chosen_sanpham}</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-group" id="dn_detail_soluong1">
                                                        <label class="control-label">{$languages.soluong}</label>
                                                        <input class="form-control" type="number" min="0" name="dn_detail_soluong" placeholder="{$languages.placeholder_soluong}" value="" level="1">
                                                    </div>
                                                </div>
                                                 <div class="col-md-2">
                                                    <div class="form-group" id="donvitinh_id1">
                                                        <label class="control-label">{$languages.donvi}</label>
                                                        <select class="chosen-select form-control" name="donvitinh_id" level="1">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group" id="hang_id1">
                                                        <label class="control-label">{$languages.hang}</label>
                                                        <select class="chosen-select form-control" name="hang_id" level="1">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group" id="dn_detail_soluong1">
                                                        ...
                                                        <input class="form-control" type="text" name="ghichu" value="" level="1">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="clearfix form-actions">
                            <div class="col-md-offset-4 col-md-9">
                                <button class="btn btn-md btn-danger" type="button" onclick="_cancel()">
                                    <i class="ace-icon fa fa-times bigger-110"></i> {$languages.detail_delete}
                                </button>
