...
{block name=script}
    ...
    function _load() {
        table = $('#table').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "{site_url()}muasam/donvitinh/ajax_list",
                "type": "POST"
            },
            "columnDefs": [
                {
    ...
    function _add() {
        ...
        $('.modal-title').text('{$languages.title_create}'); // Set Title to Bootstrap modal title
        $("#btnSua").hide();
        $("#btnSave").show();
    }
    function _xoa(id) {
            ...
            buttons: {
                '{$languages.co}': {
                    ...
                    action: function () {
                        $.ajax({
                            type: "POST",
                            url: "{site_url()}muasam/donvitinh/xoadonvitinh",
                            data: {
                                iddonvitinhxoa: id
                            },
                            datatype: "text",
                ...
                buttons: {
                    '{$languages.co}': {
                        ...
                        action: function () {
                            $.ajax({
                                type: "POST",
                                url: "{site_url()}muasam/donvitinh/suadonvitinh",
                                data: {
    ...
    function _save() {
        if ($("#name").val() == "") {
            ...
            $.ajax({
                url: "{site_url()}muasam/donvitinh/ajax_add",
                type: "POST",
                data: $('#form').serialize(),
                dataType: "JSON",
                success: function (data) {
