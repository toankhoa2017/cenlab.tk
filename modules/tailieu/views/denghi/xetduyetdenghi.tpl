...
<script type="text/javascript">
    ...
    jQuery(function($){
        ...
        $("#de_nghi_ket_qua_id").change(function(){
            if(this.value == 1){ // chấp nhận đề nghị
                $("#de_nghi_date_start").removeClass("ignore");
                $("#de_nghi_date_end").removeClass("ignore");
                $('#de_nghi_user_receive').removeClass("ignore");
                $(".date-start").show();
                $(".date-end").show();
                $(".user-soan-thao").show();
                $(".user-soan-thao span.select2").width("548");
            }else{
                $("#de_nghi_date_start").addClass("ignore");
                $("#de_nghi_date_end").addClass("ignore");
                $("#de_nghi_user_receive").addClass("ignore");
                $(".date-start").hide();
                $(".date-end").hide();
                $(".user-soan-thao").hide();
            }
...
<div class="row">
    <div class="col-xs-12">
        ...
        <form class="form-horizontal" id="validation-form" role="form" action="{site_url()}tailieu/denghi/createduyetdenghi" method="post" name="createdenghi" id="createdenghi">
            ...
            <div class="form-group">
                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Xét duyệt </label>
                <div class="col-sm-6">
            ...
            <div class="form-group date-start ignore">
                <label class="col-sm-3 control-label no-padding-right" for="form-field-1">{$label_date_start}</label>
                <div class="col-sm-6">
            ...
            <div class="form-group date-end ignore">
                <label class="col-sm-3 control-label no-padding-right" for="form-field-1">{$label_date_end}</label>
                <div class="col-sm-6">
                    <div class="input-group">
            ...
            <div class="form-group ignore user-soan-thao">
                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> {$label_user_assign} </label>
                <div class="col-sm-6">
