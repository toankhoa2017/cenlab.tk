        ...
        <div class="main-content-inner">
            ...
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li><a href="{site_url()}phongthinghiem/duyethopdong">Danh sách đề nghị chỉnh sửa</a></li>
                    <li class="active">Đề nghị chỉnh sửa</li>
                </ul>
            </div>
            <!--PATH ENDS-->
            <div class="page-content">
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <h3 class="header smaller lighter blue"><i class="fa fa-list" aria-hidden="true"></i> PHIẾU YÊU CẦU ĐỀ NGHỊ CHỈNH SỬA</h3>
                        {if $data['error']}
...
function LoadHopdong(callBack = false) {
    table = $('#list-hopdong').DataTable({
        ...
        "ajax": {
            "url": "{site_url()}phongthinghiem/duyethopdong/ajax_list",
            "type": "GET",
            "data": {
                "get_all" : "all",
