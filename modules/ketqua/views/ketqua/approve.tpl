                        ...
                        <div class="tabbable">
                            <ul class="nav nav-tabs" id="myTab">
                                <li {if !$data['approved']}class="active"{/if}>
                                    <a href="{site_url()}ketqua/duyetketqua" aria-expanded="true">
                                        <i class="green ace-icon bigger-120 fa fa-tasks"></i> Đang chờ duyệt
                                    </a>
                                </li>
                                <li {if $data['approved'] && $data['approved'] == '1'}class="active"{/if}>
                                    <a href="{site_url()}ketqua/duyetketqua?approved=1" aria-expanded="false">
...
function LoadKetQua(callBack = false) {
    table = $('#list-ketqua').DataTable({
        ...
        "ajax": {
            "url": "{site_url()}ketqua/ajax_list_approve",
            "type": "GET",
            "data": {
