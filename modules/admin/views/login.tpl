...
<head>
	...
	{switch $host}
	{case "test"}
	{assign var="host_name" value="TEST"}
	{/case}
	{case "demo"}
	{assign var="host_name" value="DEMO"}
	{/case}
	{default}
	{assign var="host_name" value="CENLAB"}
	{/case}
	{/switch}
	<title>{$host_name} - Login</title>
...
<!--[if lte IE 9]>
<link rel="stylesheet" href="{$assets_path}css/ace-part2.min.css" />
<![endif]-->
					...
					<div class="login-container">
						<div class="center">
							<h1>
								...
								<span class="red">{$host_name}</span>
								<span class="white" id="id-text2">LAB</span>
							</h1>
						</div>
