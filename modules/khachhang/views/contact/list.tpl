        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="form" method="post">
                    <input type="hidden" id="congty_id" name="congty_id" />
        ...
        <div class="main-content-inner">
            ...
            <div class="page-content">
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <h3 class="header smaller lighter blue">{$info.congty_name}</h3>
                        <div class="clearfix">
