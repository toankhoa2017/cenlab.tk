...
{block name=script}
    ...
    function _load() {
        table = $('#table').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "{site_url()}vattu/donvitinh/ajax_list",
                "type": "POST"
            },
            "columnDefs": [
                {
            ...
            buttons: {
                '{$languages.co}': {
                    ...
                    action: function () {
                        $.ajax({
                            type: "POST",
                            url: "{site_url()}vattu/donvitinh/xoadonvitinh",
                            data: {
                                iddonvitinhxoa: id
                            },
                            datatype: "text",
                ...
                buttons: {
                    '{$languages.co}': {
                        ...
                        action: function () {
                            $.ajax({
                                type: "POST",
                                url: "{site_url()}vattu/donvitinh/suadonvitinh",
                                data: {
    ...
    function _save() {
        if ($("#name").val() == "") {
            ...
            $.ajax({
                url: "{site_url()}vattu/donvitinh/ajax_add",
                type: "POST",
                data: $('#form').serialize(),
                dataType: "JSON",
                success: function (data) {
